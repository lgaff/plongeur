...
package body Kernel.Initialisation is
   ...
   procedure Go_To_Higher_Half (Directory : in out Page_Directory;
      ...
      Virtual_Address : Page_Address := 0;
      use ASCII;
   begin
      for K in Table_Range loop
         Page_K := Page_Address (K * 4096);
      ...
      Virtual_Address := Physical_To_Virtual (Table'Address) +
        Kernel_Fake_Base;
      ...
      Directory (0) := (VAddress => Virtual_Address,
                        Metadata => 0,
                        Page_Size => 0,
                        Access_Bit => 0,
                        Cache_Disable => 0,
                        ...
                        Page_Present => Page_Is_Present,
                        Read_Write => Page_Is_Writable);
      Directory (768) := (VAddress => Virtual_Address,
                          Metadata => 0,
                          Page_Size => 0,
                          Access_Bit => 0,
                          Cache_Disable => 0,
