...
package body Multiboot is
   ...
   function Get_Binary_Format return Binary_Formats is
   begin
      if System_Map.Features.Aout_Symbols_Present
      and not System_Map.Features.Elf_Header_Present then
         return Aout;
   ...
   function First_Memory_Map_Entry return Memory_Map_Entry_Pointer is
   begin
      return To_Entry_Pointer
         (Convert.To_Pointer (System_Map.Memory_Map.Address));
   ...
   begin
      Current_Address := To_Unsigned_32
         (Convert.To_Address (To_Object_Pointer (Current)));
      ...
      if Current_Address >= Map_Bounds then
         ...
         return To_Entry_Pointer
            (Convert.To_Pointer (To_Address (Current_Address)));
      end if;
